...
function setup () {
  ...
  for (let i = 100; i < 500; i += 20) 
    ...
    for (let j = 100; j < 300; j += 50) {
      ...
      rotate(mouseY)
      fill(random(255),0,0)
      triangle(200, 100, 20, 150, 100, 150)
      triangle(390, 100, 20, 300, 100, 150)
      triangle(200, 100, 20, 300*2, 100, 150)
    triangle(200, 100, 400, 300*2, 100, 150)
    triangle(200, 100, 400, 300, 100, 150)
    triangle(100, -20, 300, 200, 100, 150)
      }
    }
